    ...
    <MenuRoot>
      <MenuTrigger asChild disabled={disabled}>
        <Button
          ...
          size="sm"
        >
          {iconBlockFormat[blockType].icon}
      ...
      {toolbarState.blockType === "code" ? (
        <MenuRoot>
          <MenuTrigger disabled={!isEditable} asChild>
            <Button
              size="sm"
              variant={toolbarState.isBold ? "subtle" : "ghost"}
            >
              {getLanguageFriendlyName(toolbarState.codeLanguage)}
            </Button>
          </MenuTrigger>
          <MenuContent aria-label="Code Language">
        ...
        <>
          ...
          <IconButton
            size="sm"
            rounded="lg"
            variant={toolbarState.isItalic ? "subtle" : "ghost"}
            disabled={!isEditable}
            onClick={() => {
          ...
          <IconButton
            ...
            variant={toolbarState.isUnderline ? "subtle" : "ghost"}
          ...
          <IconButton
            ...
            disabled={!isEditable}
            onClick={insertLink}
            variant={toolbarState.isLink ? "subtle" : "ghost"}
          ...
          <MenuRoot>
            ...
            <MenuContent aria-label="Block Format">
              <MenuItem
                onClick={() => {
                  activeEditor.dispatchCommand(
                    FORMAT_TEXT_COMMAND,
